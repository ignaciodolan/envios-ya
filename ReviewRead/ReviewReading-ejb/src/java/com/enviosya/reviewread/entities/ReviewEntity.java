...
public class ReviewEntity implements Serializable {
    ...
    public ReviewEntity(int rating, String comment, ReviewStatus reviewStatus, ReviewFeeling reviewFeeling, Long shipmentId, Long clientId, Date createdDate) {
        this.rating = rating;
    ...
    public void setShipmentId(Long shimpentId) {
        this.shipmentId = shimpentId;
    }
    ...
    public String toString() {
        return "com.enviosya.reviewreading.entities.ReviewEntity[ id=" + id + " ]";
    }
